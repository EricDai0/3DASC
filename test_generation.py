...
from evaluation.evaluation_metrics import jsd_between_point_cloud_sets as JSD
...
def parse_args():
    ...
    parser.add_argument('--dataroot', default='/media/ssd2/xldai/ShapeNetCore.v2.PC15k/')
    ...
    parser.add_argument('--model', default='checkpoint/generation/car_3999.pth', help="path to model (to continue training)")
